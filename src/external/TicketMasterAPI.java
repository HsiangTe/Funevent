...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "tx4PnSeM4JWNzO4n2V5nvgzd9Rx7nlE8";
	...
	private static final String SEGMENT = "segment";
	  ...
	  public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// see ticketmaster doc, _embedded(object), events(array)
	  ...
	  private String getAddress(JSONObject events) throws JSONException {
		  if (!events.isNull(EMBEDDED)) {
				JSONObject embedded = events.getJSONObject(EMBEDDED);
	  ...
	  // use for check whether search is workable 
	  private void queryAPI(double lat, double lon) {
		 ...
		 */
	  	// we use the lan and lon from URL, this main function is only test on our device
